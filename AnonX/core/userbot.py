...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("SHRI_SUPPORT")
                await self.two.join_chat("DOSTO_KI_M3HFIL")
                await self.two.join_chat("CRIMINALS_EXPOSER")
            except:
                pass
            assistants.append(2)
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("SHRI_SUPPORT")
                await self.three.join_chat("DOSTO_KI_M3HFIL")
                await self.three.join_chat("CRIMINALS_EXPOSER")
            except:
                pass
            assistants.append(3)
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("SHRI_SUPPORT")
                await self.four.join_chat("DOSTO_KI_M3HFIL")
                await self.four.join_chat("CRIMINALS_EXPOSER")
            except:
                pass
            assistants.append(4)
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("SHRI_SUPPORT")
                await self.five.join_chat("DOSTO_KI_M3HFIL")
                await self.five.join_chat("CRIMINALS_EXPOSER")
            except:
                pass
            assistants.append(5)
